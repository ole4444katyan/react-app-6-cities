...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import type { Offer, Review, City, Location } from '../../types/types';
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
function Room({ offers, reviews, city, offersNearby }: RoomProps): JSX.Element {
  const params = useParams();
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const [selectedPoint, setSelectedPoint] = useState<Location | null>(null);

  const offerRoom = offers.find((offer) => offer.id === Number(params.id));
  // eslint-disable-next-line no-console
  // console.log(params);
  const offerReviews = reviews.filter((review) => review.offerId === Number(params.id));
    ...
    <div className="page">
      ...
      <main className="page__main page__main--property">
        <section className="property">
            ...
            <div className="property__wrapper">
              ...
              <div className="property__rating rating">
                <div className="property__stars rating__stars">
                  <span style={{ width: `${(MAX_PERCENT_STARS_WIDTH * (offerRoom?.rating ?? 0)) / STARS_COUNT}%` }}></span>
                  <span className="visually-hidden">Rating</span>
                </div>
                <span className="property__rating-value rating__value">{offerRoom?.rating}</span>
              </div>
              <ul className="property__features">

                <li className="property__feature property__feature--entire">
                  {(offerRoom?.type ?? '').charAt(0).toUpperCase() + (offerRoom?.type ?? '').slice(1)}
                </li>
              ...
              <div className="property__price">
                <b className="property__price-value">€{offerRoom?.price}</b>
          ...
          <Map
            city={city}
            locations={offersNearby.map((offer) => offer.location)}
